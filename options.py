...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--seed", type=int, default=712, help="random seed")
        ...
        self.parser.add_argument("--exp_name", type=str, default='experiment', help="name of experiment")
        ...
        self.parser.add_argument("--scheduler", type=list, default=[400, 800, 1200, 1600, 2000], help="learning rete scheduler")
